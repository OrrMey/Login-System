...
with open(os.path.join(BASE_DIR, 'CommunicationLTD/password_requirements.json')) as f:
...
SECRET_KEY = 'django-insecure-a%6qb@@1uf70oow$tpj!a+0e!6b1!&d70r-zelitbif5u-krvc'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'CommunicationLTD.context_processor.isauth_context_processor'
            ],
        },
    },
]
